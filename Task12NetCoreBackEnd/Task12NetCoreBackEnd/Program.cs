...
using Task12NetCoreBackEnd.Mapping;
...
builder.Services.AddAutoMapper(typeof(Program), typeof(FinanceTypeToFinanceTypeViewModelProfile), typeof(MoneyOperationToMoneyOperationViewModelProfile));
